var hawkApp = (function(publicMethods) {
    ...
    publicMethods.initialLoad = function(){
        ...
        var ScoreView = React.createClass({displayName: "ScoreView",
            ...
            render : function() {
                return (
                    React.createElement("div", {className: "center"}, 
                        React.createElement("p", null, " The next game is on ", this.state.hawkScoreData.day, " at ", this.state.hawkScoreData.time), 
                        React.createElement("p", null, " Seahawks : ", this.state.hawkScoreData.seahawkScore, " "), 
                        React.createElement("p", null, " ", this.state.hawkScoreData.enemyName, " : ", this.state.hawkScoreData.enemyScore, " ")
                    )
                );
            }
        });
        ...
        React.render(
            React.createElement(ScoreView, null),
